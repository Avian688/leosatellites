...
cOrbitA::cOrbitA(std::string satNameA, int epochY, double epochD, double mMotion, double ecc, double incl, double meanAnom, double bstarA, double dragA, int satIndex, int planes, int satPerPlane) :
   m_pNoradModel(NULL)
{
   satName = satNameA;
   epochYear = epochY;
