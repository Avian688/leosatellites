...
#ifndef LEOSATELLITES_LeoNetworkConfigurator_H_
#define LEOSATELLITES_LeoNetworkConfigurator_H_
 ...
 */
class LeoNetworkConfigurator : public Ipv4NetworkConfigurator{
    public:
...
//        virtual void addStaticRoutes(Topology& topology, cXMLElement *element);
    ...
    protected:
        ...
        bool linksEstablished = false;
        virtual void handleMessage(cMessage *msg) override;
        virtual void initialize(int stage) override;

};
}
#endif /* OS3_NETWORKLAYER_CONFIGURATOR_IPV4_LeoNetworkConfigurator_H_ */
